...
public class ClueRemarkController {
    ...
    public Object saveCreateClueRemark(ClueRemark clueRemark, HttpSession session) {
        ...
        clueRemark.setEditFlag(Contants.REMARK_EDIT_FLAG_FALSE);
        ...
        try {
            ...
            if (res > 0) { // 插入成功
                ...
                returnObject.setRetData(clueRemark); // 将备注也传到前端响应到页面
    ...
    public Object saveEditClueRemark(ClueRemark clueRemark, HttpSession session) {
        User user = (User) session.getAttribute(Contants.SESSION_USER);
        // 封装参数
        clueRemark.setEditFlag(Contants.REMARK_EDIT_FLAG_TRUE);
