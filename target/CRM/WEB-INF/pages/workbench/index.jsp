    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#changePwd").click(function () {
                ...
                $.ajax({
                    url: "workbench/changePassword.do",
                    data: {
                        oldPwd: oldPwd,
                        loginPwd: loginPwd,
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="loginPwd" style="width: 200%;">
                        </div>
                    </div>
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        CRM &nbsp;<span style="font-size: 12px;">&copy;2023&nbsp;shen</span></div>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            ...
            <li class="liClass"><a href="settings/error/nopage.do" target="workareaFrame"><span
            ...
            <li class="liClass"><a href="workbench/visit/index.do" target="workareaFrame"><span
